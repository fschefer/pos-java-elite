...
> *Este projeto acompanha minha jornada na especialização em Java, integrando teoria e prática avançada.*

Repositório central de estudos (Knowledge Base) e implementações práticas (Lab) da Pós-Graduação Java Elite da UNIPDS. O foco é dominar desde a engenharia profunda da linguagem até arquiteturas de microsserviços e IA.
...
| **01. Fundamentos (Advanced)** | Gradle, Concurrency, JDBC, Networking | 🔄 **Em andamento** |
...
- **`01-Fundamentos/`**: Notas de estudo detalhadas (formato Obsidian).
- **`projeto-java/`**: Código fonte prático (Maven).
